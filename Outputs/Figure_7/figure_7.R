...
venn_plot <- grid.arrange(plot(venn_fish_all, quantities = list(col = "black", cex = 1),lty = c(3,2,1),fill = c("grey","cadetblue3","steelblue3"),labels = list(col = "black", cex = 1),alpha=c(0.1,0.3,0.6)),
