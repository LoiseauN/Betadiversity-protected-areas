rm(list=ls())
setwd("~/Documents/Postdoc MARBEC/BETA PROTECTED AREA_CLEAN/DataforFig2")
file_names=as.list(dir(pattern="50*"))
...
#################################FISH##################################################################################################### 
S_bird_closed_50vsNP<-S_closed_50vsNP
S_bird_closed_50vsrester <-S_closed_50vsrester
S_bird_NP_50vsclosed<-S_NP_50vsclosed
S_bird_NP_50vsrestr<-S_NP_50vsrestr
S_bird_restricted_50vsclose<-S_restricted_50vsclose
S_bird_restricted_50vsNP<-S_restricted_50vsNP

S_bird_closed_50vsNP<-S_bird_closed_50vsNP[apply(S_bird_closed_50vsNP,1,mean)>0,]
S_bird_closed_50vsrester<-S_bird_closed_50vsrester[apply(S_bird_closed_50vsrester,1,mean)>0,]
S_bird_NP_50vsclosed<-S_bird_NP_50vsclosed[apply(S_bird_NP_50vsclosed,1,mean)>0,]
S_bird_NP_50vsrestr<-S_bird_NP_50vsrestr[apply(S_bird_NP_50vsrestr,1,mean)>0,]
S_bird_restricted_50vsclose<-S_bird_restricted_50vsclose[apply(S_bird_restricted_50vsclose,1,mean)>0,]
S_bird_restricted_50vsNP<-S_bird_restricted_50vsNP[apply(S_bird_restricted_50vsNP,1,mean)>0,]

S_fish_closed_50vsNP<-S_fish_closed_50vsNP[apply(S_fish_closed_50vsNP,1,mean)>0,]
S_fish_closed_50vsrester<-S_fish_closed_50vsrester[apply(S_fish_closed_50vsrester,1,mean)>0,]
S_fish_NP_50vsclosed<-S_fish_NP_50vsclosed[apply(S_fish_NP_50vsclosed,1,mean)>0,]
S_fish_NP_50vsrestr<-S_fish_NP_50vsrestr[apply(S_fish_NP_50vsrestr,1,mean)>0,]
S_fish_restricted_50vsclose<-S_fish_restricted_50vsclose[apply(S_fish_restricted_50vsclose,1,mean)>0,]
S_fish_restricted_50vsNP<-S_fish_restricted_50vsNP[apply(S_fish_restricted_50vsNP,1,mean)>0,]

S_plant_closed_50vsNP<-S_plant_closed_50vsNP[apply(S_plant_closed_50vsNP,1,mean)>0,]
S_plant_closed_50vsrester<-S_plant_closed_50vsrester[apply(S_plant_closed_50vsrester,1,mean)>0,]
S_plant_NP_50vsclosed<-S_plant_NP_50vsclosed[apply(S_plant_NP_50vsclosed,1,mean)>0,]
S_plant_NP_50vsrestr<-S_plant_NP_50vsrestr[apply(S_plant_NP_50vsrestr,1,mean)>0,]
S_plant_restricted_50vsclose<-S_plant_restricted_50vsclose[apply(S_plant_restricted_50vsclose,1,mean)>0,]
S_plant_restricted_50vsNP<-S_plant_restricted_50vsNP[apply(S_plant_restricted_50vsNP,1,mean)>0,]
S_plant_closed_50vsNP<-S_plant_closed_50vsNP[apply(S_plant_closed_50vsNP,1,mean)>0,]
...
p1<- ggplot(Fish, aes(scale,RS,colour=scale)) +
  ...
  labs(title = "",
       ...
       colour = "",size=15) +
  theme_bw() +  annotation_custom(rasterGrob(img),  xmin = 2.8, xmax = 3.6, ymin = -65, ymax = -90) +
...
yolo<-data.frame(c(apply(S_fish_closed_50vsNP,1,mean),apply(S_fish_NP_50vsclosed,1,mean)),c(rep("close",dim(S_fish_closed_50vsNP)[1]),rep("np",dim(S_fish_NP_50vsclosed)[1])))
summary(aov(yolo[,1]~yolo[,2]))
yolo<-data.frame(c(apply(S_fish_closed_50vsrester,1,mean),apply(S_fish_restricted_50vsclose,1,mean)),c(rep("close",dim(S_fish_closed_50vsrester)[1]),rep("np",dim(S_fish_restricted_50vsclose)[1])))
summary(aov(yolo[,1]~yolo[,2]))
yolo<-data.frame(c(apply(S_fish_restricted_50vsNP,1,mean),apply(S_fish_NP_50vsrestr,1,mean)),c(rep("close",dim(S_fish_restricted_50vsNP)[1]),rep("np",dim(S_fish_NP_50vsrestr)[1])))
summary(aov(yolo[,1]~yolo[,2]))
...
p2<-ggplot(bird, aes(scale,RS,colour=scale)) +
  ...
  labs(title = "",
       ...
       y = "",
       colour = "") +
  theme_bw() +  annotation_custom(rasterGrob(img2),  xmin = 2.8, xmax = 3.6, ymin = -120, ymax = -75)+
  annotation_custom(my_grob1)+annotation_custom(my_grob2)+annotation_custom(my_grob3)+
  theme(axis.title.y = element_text(size=16),axis.text.x = element_text(size=14))
#+ coord_flip()
...
yolo<-data.frame(c(apply(S_bird_closed_50vsNP,1,mean),apply(S_bird_NP_50vsclosed,1,mean)),c(rep("close",dim(S_bird_closed_50vsNP)[1]),rep("np",dim(S_bird_NP_50vsclosed)[1])))
summary(aov(yolo[,1]~yolo[,2]))
yolo<-data.frame(c(apply(S_bird_closed_50vsrester,1,mean),apply(S_bird_restricted_50vsclose,1,mean)),c(rep("close",dim(S_bird_closed_50vsrester)[1]),rep("np",dim(S_bird_restricted_50vsclose)[1])))
summary(aov(yolo[,1]~yolo[,2]))
yolo<-data.frame(c(apply(S_bird_restricted_50vsNP,1,mean),apply(S_bird_NP_50vsrestr,1,mean)),c(rep("close",dim(S_bird_restricted_50vsNP)[1]),rep("np",dim(S_bird_NP_50vsrestr)[1])))
summary(aov(yolo[,1]~yolo[,2]))
...
p3<-ggplot(Plant, aes(scale,RS,colour=scale)) +
  ...
  labs(title = "",
       ...
       y = "",
       colour = "") +
  theme_bw() +  annotation_custom(rasterGrob(img3),  xmin = 2.8, xmax = 3.6, ymin = -980, ymax = -850)+
  annotation_custom(my_grob1)+annotation_custom(my_grob2)+annotation_custom(my_grob3)+
  theme(axis.title.y = element_text(size=16),axis.text.x = element_text(size=14))
...
yolo<-data.frame(c(apply(S_plant_closed_50vsrester,1,mean),apply(S_plant_restricted_50vsclose,1,mean)),c(rep("close",dim(S_plant_closed_50vsrester)[1]),rep("np",dim(S_plant_restricted_50vsclose)[1])))
summary(aov(yolo[,1]~yolo[,2]))
yolo<-data.frame(c(apply(S_plant_closed_50vsNP,1,mean),apply(S_plant_NP_50vsclosed,1,mean)),c(rep("close",dim(S_plant_closed_50vsNP)[1]),rep("np",dim(S_plant_NP_50vsclosed)[1])))
summary(aov(yolo[,1]~yolo[,2]))
yolo<-data.frame(c(apply(S_plant_restricted_50vsNP,1,mean),apply(S_plant_NP_50vsrestr,1,mean)),c(rep("close",dim(S_plant_restricted_50vsNP)[1]),rep("np",dim(S_plant_NP_50vsrestr)[1])))
summary(aov(yolo[,1]~yolo[,2]))
